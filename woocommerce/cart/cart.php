			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-remove col-md-1">
							<?php
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="remove" title="%s">&times;</a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), __( 'Remove this item', 'woocommerce' ) ), $cart_item_key );
							?>
						</td>

						<td class="product-thumbnail col-md-1">
							<?php
						...
						<td class="product-name col-md-2">
							<?php
								if ( ! $_product->is_visible() )
						...
						<td class="product-price col-md-2">
							<?php
						...
						<td class="product-subtotal col-md-2">
							<?php
...
<div class="actions">
	...
	<input type="submit" class="btn btn-default" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>" />
