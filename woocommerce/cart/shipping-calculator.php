...
<form class="shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<h5><a href="#" class="btn btn-default"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h5>
