	...
	<div class="table-responsive">
		<table class="table">
			...
			<tr class="cart-subtotal">
				<th class="col-md-3"><?php _e( 'Cart Subtotal', 'woocommerce' ); ?></th>
				<td class="col-md-9"><?php wc_cart_totals_subtotal_html(); ?></td>
			</tr>

			<?php foreach ( WC()->cart->get_coupons( 'cart' ) as $code => $coupon ) : ?>
				<tr class="cart-discount coupon-<?php echo esc_attr( $code ); ?>">
					<th class="col-md-3"><?php wc_cart_totals_coupon_label( $coupon ); ?></th>
					<td class="col-md-9"><?php wc_cart_totals_coupon_html( $coupon ); ?></td>
				</tr>
			<?php endforeach; ?>
