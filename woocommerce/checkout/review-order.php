...
<?php if ( ! $is_ajax ) : ?><div id="order_review"><?php endif; ?>
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th class="product-name col-md-4"><?php _e( 'Product', 'woocommerce' ); ?></th>
					<th class="product-total col-md-8"><?php _e( 'Total', 'woocommerce' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php
	...
	<div id="payment" class="row">
		<div class="col-md-6 payment_methods methods">
